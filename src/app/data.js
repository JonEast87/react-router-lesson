...
export const AUTHORS = {
	...
	Nick: {
		articles: ['browser-compatibility', 'accessible-colors'],
	},
	Lily: {
		articles: ['authentication-and-oauth', 'black-box-programming'],
	},
}
...
export const CATEGORIES = {
	...
	javascript: ['objects'],
	html: ['accessibility-and-html', 'browser-compatibility'],
}
